...
5. (ti increae randm in request sn fiels check )Pro Tip: Instead of a simple for loop, look into a tool called Locust. It allows you to simulate 100 users hitting the API simultaneously with different data. 6. To keep it(promethus api record ) "in code" or on your disk, you need a Volume.